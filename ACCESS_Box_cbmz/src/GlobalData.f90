...
module GlobalData
  ...
  character(len=11),parameter :: gasmech='cbmz'

  ! Generated by chmgen for mechanism cbmz
  ! ninteg - number of integrated species
  integer(kind=i4), parameter :: ninteg=52
  ...
  integer(kind=i4), parameter :: nrxn=132
  ...
  integer(kind=i4), parameter :: iNO3         = 6
  integer(kind=i4), parameter :: iHONO        = 7
  integer(kind=i4), parameter :: iHNO3        = 8
  integer(kind=i4), parameter :: iHNO4        = 9
  integer(kind=i4), parameter :: iN2O5        = 10
  integer(kind=i4), parameter :: iOH          = 11
  integer(kind=i4), parameter :: iHO2         = 12
  integer(kind=i4), parameter :: iH2O2        = 13
  integer(kind=i4), parameter :: iHCHO        = 14
  integer(kind=i4), parameter :: iCO          = 15
  integer(kind=i4), parameter :: iCH3OOH      = 16
  integer(kind=i4), parameter :: iETHOOH      = 17
  integer(kind=i4), parameter :: iALD2        = 18
  integer(kind=i4), parameter :: iCH3O2       = 19
  integer(kind=i4), parameter :: iAONE        = 20
  integer(kind=i4), parameter :: iC2O3        = 21
  integer(kind=i4), parameter :: iMGLY        = 22
  integer(kind=i4), parameter :: iOPEN        = 23
  integer(kind=i4), parameter :: iROOH        = 24
  integer(kind=i4), parameter :: iXO2         = 25
  integer(kind=i4), parameter :: iETHP        = 26
  integer(kind=i4), parameter :: iPAR         = 27
  integer(kind=i4), parameter :: iONIT        = 28
  integer(kind=i4), parameter :: iISOPRD      = 29
  integer(kind=i4), parameter :: iSO2         = 30
  integer(kind=i4), parameter :: iH2SO4       = 31
  integer(kind=i4), parameter :: iCH4         = 32
  integer(kind=i4), parameter :: iC2H6        = 33
  integer(kind=i4), parameter :: iRO2         = 34
  integer(kind=i4), parameter :: iCH3OH       = 35
  integer(kind=i4), parameter :: iANO2        = 36
  integer(kind=i4), parameter :: iC2H4        = 37
  integer(kind=i4), parameter :: iHCOOH       = 38
  integer(kind=i4), parameter :: iOLET        = 39
  integer(kind=i4), parameter :: iRCOOH       = 40
  integer(kind=i4), parameter :: iOLEI        = 41
  integer(kind=i4), parameter :: iNAP         = 42
  integer(kind=i4), parameter :: iTOL         = 43
  integer(kind=i4), parameter :: iCRES        = 44
  integer(kind=i4), parameter :: iTO2         = 45
  integer(kind=i4), parameter :: iXYL         = 46
  integer(kind=i4), parameter :: iCRO         = 47
  integer(kind=i4), parameter :: iISOP        = 48
  integer(kind=i4), parameter :: iISOPP       = 49
  integer(kind=i4), parameter :: iISOPN       = 50
  integer(kind=i4), parameter :: iISOPO2      = 51
  integer(kind=i4), parameter :: iPAN         = 52

  ! Species strings
  character(len=6), parameter, dimension(ntotal) ::  &
                     sspc     = (/         &
                                   'NO    ', &
                                   'NO2   ', &
                                   'O3    ', &

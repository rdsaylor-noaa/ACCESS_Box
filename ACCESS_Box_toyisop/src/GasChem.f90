...
subroutine fgaschem(neqn, ts, y, yp )
  ...
  ! Generated by chmgen for mechanism toyisop
  yp(iNO)        = -r(3)+r(4)-r(7)-r(9)-r(9)-r(10)+r(11)-r(21)-r(24)+r(33)+r(34)+r(36)-r(43)-r(44)
  yp(iNO2)       = +r(3)-r(4)-r(5)+r(7)-r(8)+r(9)+r(9)+r(10)+r(10)-r(11)+r(11)-r(12)-r(22)+r(23)+r(24) &
                    -r(25)+r(26)+r(27)+r(28)-r(33)+r(35)+r(37)+r(38)+r(39)+r(44)-r(45)+r(46)+r(54)+r(55)+r(57)
  yp(iO3)        = +r(1)-r(2)-r(7)-r(8)-r(14)-r(18)-r(30)-r(31)-r(60)
  yp(iNO3)       = +r(5)+r(8)-r(10)-r(11)-r(12)-r(23)-r(27)+r(29)-r(34)-r(35)+r(38)-r(46)-r(52)-r(61)
  yp(iO)         = -r(1)-r(2)-r(3)-r(4)-r(5)+r(6)+r(31)+r(33)+r(35)
  yp(iO1D)       = -r(6)-r(13)+r(30)
  yp(iN2O5)      = +r(12)-r(38)
  yp(iOH)        = +r(13)+r(13)-r(14)-r(15)-r(16)-r(17)+r(18)-r(19)-r(21)-r(22)-r(23)+r(24)-r(26)+r(27) &
                    -r(28)-r(29)+r(32)+r(32)+r(36)+r(37)-r(40)+r(47)-r(48)-r(49)+r(49)-r(53)-r(55)-r(58)-r(59)
  yp(iHO2)       = +r(14)+r(15)+r(16)+r(17)-r(18)-r(19)-r(20)-r(20)+r(23)-r(24)-r(25)-r(27)+r(39)-r(41) &
                    -r(42)+r(50)+r(50)+r(52)+r(53)+r(56)+r(58)
  yp(iCO)        = -r(16)+r(50)+r(51)+r(52)+r(53)
  yp(iH2O2)      = -r(17)+r(20)-r(32)
  yp(iHONO)      = +r(21)-r(28)-r(36)
  yp(iHNO3)      = +r(22)-r(29)-r(37)+r(52)
  yp(iHO2NO2)    = +r(25)-r(26)-r(39)
  yp(iCH4)       = -r(40)
  yp(iCH3O2)     = +r(40)-r(41)-r(42)-r(43)-r(44)-r(45)-r(46)+r(48)+r(57)
  yp(iCH3OOH)    = +r(41)-r(47)-r(48)-r(49)
  yp(iHCHO)      = +r(42)+r(49)-r(50)-r(51)-r(52)-r(53)+r(55)+r(56)+r(58)
  yp(iCH3NO3)    = +r(43)-r(54)-r(55)
  yp(iCH3O)      = +r(44)+r(46)+r(47)+r(54)-r(56)
  yp(iCH3O2NO2)  = +r(45)-r(57)
  yp(iCH3OH)     = -r(58)
  yp(iC5H8)      = -r(59)-r(60)-r(61)
  yp(iIPROD)     = +r(59)+r(60)+r(61)
...
subroutine RxnRates(neqn,k,y,r)
  ...
  r(6)     = k(6)*y(iO1D)
  r(7)     = k(7)*y(iNO)*y(iO3)
  r(8)     = k(8)*y(iNO2)*y(iO3)
  r(9)     = k(9)*y(iNO)*y(iNO)
  r(10)    = k(10)*y(iNO)*y(iNO3)
  r(11)    = k(11)*y(iNO2)*y(iNO3)
  r(12)    = k(12)*y(iNO2)*y(iNO3)
  r(13)    = k(13)*y(iO1D)
  r(14)    = k(14)*y(iOH)*y(iO3)
  r(15)    = k(15)*y(iOH)*H2
  r(16)    = k(16)*y(iOH)*y(iCO)
  r(17)    = k(17)*y(iOH)*y(iH2O2)
  r(18)    = k(18)*y(iHO2)*y(iO3)
  r(19)    = k(19)*y(iOH)*y(iHO2)
  r(20)    = k(20)*y(iHO2)*y(iHO2)
  r(21)    = k(21)*y(iOH)*y(iNO)
  r(22)    = k(22)*y(iOH)*y(iNO2)
  r(23)    = k(23)*y(iOH)*y(iNO3)
  r(24)    = k(24)*y(iHO2)*y(iNO)
  r(25)    = k(25)*y(iHO2)*y(iNO2)
  r(26)    = k(26)*y(iOH)*y(iHO2NO2)
  r(27)    = k(27)*y(iHO2)*y(iNO3)
  r(28)    = k(28)*y(iOH)*y(iHONO)
  r(29)    = k(29)*y(iOH)*y(iHNO3)
  r(30)    = k(30)*y(iO3)
  r(31)    = k(31)*y(iO3)
  r(32)    = k(32)*y(iH2O2)
  r(33)    = k(33)*y(iNO2)
  ...
  r(38)    = k(38)*y(iN2O5)
  r(39)    = k(39)*y(iHO2NO2)
  r(40)    = k(40)*y(iOH)*y(iCH4)
  r(41)    = k(41)*y(iCH3O2)*y(iHO2)
  r(42)    = k(42)*y(iCH3O2)*y(iHO2)
  r(43)    = k(43)*y(iCH3O2)*y(iNO)
  r(44)    = k(44)*y(iCH3O2)*y(iNO)
  r(45)    = k(45)*y(iCH3O2)*y(iNO2)
  r(46)    = k(46)*y(iCH3O2)*y(iNO3)
  r(47)    = k(47)*y(iCH3OOH)
  r(48)    = k(48)*y(iOH)*y(iCH3OOH)
  r(49)    = k(49)*y(iOH)*y(iCH3OOH)
  r(50)    = k(50)*y(iHCHO)
  r(51)    = k(51)*y(iHCHO)
  r(52)    = k(52)*y(iNO3)*y(iHCHO)
  r(53)    = k(53)*y(iOH)*y(iHCHO)
  r(54)    = k(54)*y(iCH3NO3)
  r(55)    = k(55)*y(iOH)*y(iCH3NO3)
  r(56)    = k(56)*y(iCH3O)
  r(57)    = k(57)*y(iCH3O2NO2)
  r(58)    = k(58)*y(iCH3OH)*y(iOH)
  r(59)    = k(59)*y(iC5H8)*y(iOH)
  r(60)    = k(60)*y(iC5H8)*y(iO3)
  r(61)    = k(61)*y(iC5H8)*y(iNO3)
...
subroutine GasThermalRateCoeffs(ts, k)
  ...
  ! Generated by chmgen for mechanism toyisop
  k(1)     = 5.6D-34*N2*(TEMP/300)**(-2.6)*O2+6.0D-34*O2*(TEMP/300)**(-2.6)*O2
  k(2)     = 8.0D-12*EXP(-2060/TEMP)
  k(3)     = TERM(9.0D-32,-1.5D0,0.0D0,3.0D-11,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(4)     = 5.1D-12*EXP(210/TEMP)
  k(5)     = TERM(2.5D-31,-1.8D0,0.0D0,2.2D-11,-0.7D0,0.0D0,0.6D0,TEMP,AIR)
  k(6)     = 3.3D-11*EXP(55/TEMP)*O2+2.15D-11*EXP(110/TEMP)*N2
  k(7)     = 1.4D-12*EXP(-1310/TEMP)
  k(8)     = 1.4D-13*EXP(-2470/TEMP)
  k(9)     = 3.3D-39*EXP(530/TEMP)*O2
  k(10)    = 1.8D-11*EXP(110/TEMP)
  k(11)    = 4.50D-14*EXP(-1260/TEMP)
  k(12)    = TERM(2.0D-30,-4.4D0,0.0D0,1.4D-12,-0.7D0,0.0D0,0.6D0,TEMP,AIR)
  k(13)    = 2.14D-10*H2Oz
  k(14)    = 1.70D-12*EXP(-940/TEMP)
  k(15)    = 7.7D-12*EXP(-2100/TEMP)
  k(16)    = KTYP3(1.44D-13,0.0D0,3.43D-33,0.0D0,TEMP,AIR)
  k(17)    = 2.9D-12*EXP(-160/TEMP)
  k(18)    = 2.03D-16*(TEMP/300)**4.57*EXP(693/TEMP)
  k(19)    = 4.8D-11*EXP(250/TEMP)
  k(20)    = KTYP3(2.3D-13,600.0D0,1.7D-33,1000.0D0,TEMP,AIR)
  k(21)    = TERM(7.0D-31,-2.6D0,0.0D0,3.6D-11,-0.1D0,0.0D0,0.6D0,TEMP,AIR)
  k(22)    = TERM(2.0D-30,-3.0D0,0.0D0,2.5D-11,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(23)    = 2.0D-11
  k(24)    = 3.45D-12*EXP(270/TEMP)
  k(25)    = TERM(1.8D-31,-3.2D0,0.0D0,4.7D-12,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(26)    = 3.2D-13*EXP(690/TEMP)*1.0
  k(27)    = 4.0D-12
  k(28)    = 2.5D-12*EXP(260/TEMP)
  k(29)    = KTYP2(2.4D-14,460.0D0,2.7D-17,2199.0D0,6.5D-34,1335.0D0,TEMP,AIR)
  k(38)    = TERM(1.0D-3,-3.5D0,-11000.0D0,9.7D+14,0.1D0,-11080.0D0,0.45D0,TEMP,AIR)
  k(39)    = TERM(4.1D-5,0.0D0,-10650.0D0,4.8D+15,0.0D0,-11170.0D0,0.6D0,TEMP,AIR)
  k(40)    = 1.85D-12*EXP(-1690/TEMP)
  k(41)    = 3.8D-13*EXP(780/TEMP)*(1-1/(1+498*EXP(-1160/TEMP)))
  k(42)    = 3.8D-13*EXP(780/TEMP)*(1/(1+498*EXP(-1160/TEMP)))
  k(43)    = 2.3D-12*EXP(360/TEMP)*0.001
  k(44)    = 2.3D-12*EXP(360/TEMP)*0.999
  k(45)    = TERM(1.0D-30,-4.8D0,0.0D0,7.2D-12,-2.1D0,0.0D0,0.6D0,TEMP,AIR)
  k(46)    = 1.2D-12
  k(48)    = 5.3D-12*EXP(190/TEMP)*0.6
  k(49)    = 5.3D-12*EXP(190/TEMP)*0.4
  k(52)    = 5.5D-16
  k(53)    = 5.4D-12*EXP(135/TEMP)
  k(55)    = 4.0D-13*EXP(-845/TEMP)
  k(56)    = 7.2D-14*EXP(-1080/TEMP)*O2
  k(57)    = TERM(1.0D-30,-4.8D0,0.0D0,7.2D-12,-2.1D0,0.0D0,0.6D0,TEMP,AIR)/2.2D-12
  k(58)    = 2.85D-12*EXP(-345/TEMP)
  k(59)    = 2.7D-11*EXP(390/TEMP)
  k(60)    = 1.0D-14*EXP(-1995/TEMP)
  k(61)    = 3.1D-12*EXP(-450/TEMP)

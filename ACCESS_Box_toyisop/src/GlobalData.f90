...
module GlobalData
  ...
  character(len=11),parameter :: gasmech='toyisop'

  ! Generated by chmgen for mechanism toyisop
  ! ninteg - number of integrated species
  integer(kind=i4), parameter :: ninteg=24
  ...
  integer(kind=i4), parameter :: nrxn=61

  ! Species indices
  integer(kind=i4), parameter :: iNO          = 1
  integer(kind=i4), parameter :: iNO2         = 2
  integer(kind=i4), parameter :: iO3          = 3
  integer(kind=i4), parameter :: iNO3         = 4
  integer(kind=i4), parameter :: iO           = 5
  integer(kind=i4), parameter :: iO1D         = 6
  integer(kind=i4), parameter :: iN2O5        = 7
  integer(kind=i4), parameter :: iOH          = 8
  integer(kind=i4), parameter :: iHO2         = 9
  integer(kind=i4), parameter :: iCO          = 10
  integer(kind=i4), parameter :: iH2O2        = 11
  integer(kind=i4), parameter :: iHONO        = 12
  integer(kind=i4), parameter :: iHNO3        = 13
  integer(kind=i4), parameter :: iHO2NO2      = 14
  integer(kind=i4), parameter :: iCH4         = 15
  integer(kind=i4), parameter :: iCH3O2       = 16
  integer(kind=i4), parameter :: iCH3OOH      = 17
  integer(kind=i4), parameter :: iHCHO        = 18
  integer(kind=i4), parameter :: iCH3NO3      = 19
  integer(kind=i4), parameter :: iCH3O        = 20
  integer(kind=i4), parameter :: iCH3O2NO2    = 21
  integer(kind=i4), parameter :: iCH3OH       = 22
  integer(kind=i4), parameter :: iC5H8        = 23
  integer(kind=i4), parameter :: iIPROD       = 24
  ...
  integer(kind=i4), parameter :: noutppb=13
  integer(kind=i4), dimension(noutppb) :: outppb
  data outppb / iNO, iNO2, iO3, iHONO, iHNO3, iHO2NO2, iN2O5, iCH4, &
                iHCHO, iCO, iH2O2, iC5H8, iIPROD /

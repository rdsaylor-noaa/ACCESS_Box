...
subroutine SetMolecDiffSTP()
  ...
  mdiffstp(iHO2NO2)     =  0.1041
  mdiffstp(iCH4)        =  0.1952
  mdiffstp(iCH3O2)      =  mdiffstp_default
  mdiffstp(iCH3OOH)     =  mdiffstp_default
  mdiffstp(iHCHO)       =  mdiffstp_default
  mdiffstp(iCH3NO3)     =  mdiffstp_default
  mdiffstp(iCH3O)       =  mdiffstp_default
  mdiffstp(iCH3O2NO2)   =  mdiffstp_default
  mdiffstp(iCH3OH)      =  mdiffstp_default
  mdiffstp(iC5H8)       =  mdiffstp_default
  mdiffstp(iIPROD)      =  mdiffstp_default
...
subroutine SetEffHenrysLawCoeffs()
  ...
  hstar(iHONO)       =  2.6D+05
  hstar(iHNO3)       =  3.2D+13
  hstar(iHO2NO2)     =  1.0D+07
  hstar(iCH4)        =  1.4D-03
  hstar(iCH3O2)      =  hstar_default
  hstar(iCH3OOH)     =  hstar_default
  hstar(iHCHO)       =  4.9D+03
  hstar(iCH3NO3)     =  hstar_default
  hstar(iCH3O)       =  hstar_default
  hstar(iCH3O2NO2)   =  hstar_default
  hstar(iCH3OH)      =  hstar_default
  hstar(iC5H8)       =  hstar_default
  hstar(iIPROD)      =  hstar_default

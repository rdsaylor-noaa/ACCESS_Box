...
subroutine SetMolecDiffSTP()
  ...
  mdiffstp(iMO2)      =  0.1297
  mdiffstp(iOP1)      =  0.1200
  mdiffstp(iMOH)      =  0.1297
  mdiffstp(iNO3)      =  0.1153
  mdiffstp(iO3P)      =  0.2773
  mdiffstp(iO1D)      =  0.2773
  mdiffstp(iHO)       =  0.2543
  mdiffstp(iHO2)      =  0.2000
  mdiffstp(iORA1)     =  0.1340
  mdiffstp(iHAC)      =  0.1060
  mdiffstp(iPAA)      =  0.1040
  mdiffstp(iDHMOB)    =  0.0892
  mdiffstp(iHPALD)    =  0.0845
  mdiffstp(iISHP)     =  0.0837
  mdiffstp(iIEPOX)    =  0.0837
  mdiffstp(iPROPNN)   =  0.0834
  mdiffstp(iISOPNB)   =  0.0750
  mdiffstp(iISOPND)   =  0.0750
  mdiffstp(iMACRN)    =  0.0745
  mdiffstp(iMVKN)     =  0.0745
  mdiffstp(iISNP)     =  0.0712

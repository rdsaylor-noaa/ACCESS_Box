...
subroutine fgaschem(neqn, ts, y, yp )
  ...
  ! Generated by chmgen for mechanism mozart
  yp(iNO)           = +r(3)+0.11*r(6)-r(40)-r(41)+r(42)-r(50)-r(57)-r(65)-r(71)-r(76)-r(85)-r(90)-r(103) &
                       -r(104)-r(112)-r(113)-r(117)
  yp(iNO2)          = -r(3)+r(4)+r(5)+0.89*r(6)+r(7)+r(15)+r(16)+r(40)+r(41)-r(42)-r(43)+0.6*r(44)-r(45) &
                       +r(46)-r(48)+r(50)+r(50)-r(51)+r(52)+r(53)+r(57)+r(65)+r(71)+r(76)+r(85)+r(90)-r(91) &
                       +r(92)+r(103)+0.59*r(104)+r(112)+r(117)-r(118)+r(119)+r(124)+r(127)
  yp(iO3)           = -r(1)-r(2)+0.89*r(6)+r(28)-r(29)-r(32)-r(33)-r(41)-r(43)-r(83)+0.33*r(93)-r(99)-r(101) &
                       -r(109)-r(111)-r(126)
  yp(iO1D)          = +r(1)-r(25)-r(26)-r(27)-r(39)-r(55)-r(56)
  yp(iO3P)          = +r(2)+r(3)+r(25)+r(26)-r(28)-r(29)-r(30)-r(31)+r(37)-r(42)+0.45*r(101)+0.2*r(109)+0.2 &
                       *r(111)+0.76*r(126)
  yp(iN2O5)         = -r(4)+r(45)-r(46)-r(47)
  yp(iNO3)          = +r(4)-r(6)+r(43)-r(44)-r(45)+r(46)+r(49)-r(50)-r(62)-r(84)-r(89)-r(102)-r(116)-r(127)
  yp(iHNO3)         = -r(5)+0.4*r(44)+r(47)+r(47)+r(48)-r(49)+r(62)+r(89)+r(116)
  yp(iHO2NO2)       = -r(7)+r(51)-r(52)-r(53)
  yp(iOH)           = +r(5)+r(8)+r(11)+r(11)+r(13)+r(14)+r(20)+r(21)+r(22)+r(27)+r(27)-r(30)+r(31)-r(32) &
                       +r(33)-r(35)-r(36)-r(37)-r(37)-r(38)+r(39)+r(40)+0.6*r(44)-r(48)-r(49)-r(53)-r(54) &
                       +r(55)-r(60)+0.42*r(60)-r(61)-r(63)-r(64)-r(69)+0.5*r(69)-r(70)-r(74)-r(75)-r(78) &
                       -r(81)-r(82)+0.4*r(83)-r(87)+0.5*r(87)-r(88)-r(97)-r(98)-r(100)+0.7*r(101)-r(108)+0.08 &
                       *r(109)-r(110)+0.215*r(111)-r(115)-r(124)-r(125)+1.2*r(126)
  yp(iHO2)          = +r(7)+r(8)+r(9)+r(9)+r(12)+r(13)+r(17)+r(17)+2.6*r(18)+r(19)+r(20)+r(21)+r(24)+r(30) &
                       -r(31)+r(32)-r(33)-r(34)-r(34)+r(35)-r(36)+r(38)+r(39)-r(40)-r(44)-r(51)+r(52)+r(57)+0.8 &
                       *r(58)-r(59)+r(61)+r(62)+r(63)+r(65)-r(66)+r(67)+1.2*r(68)+r(71)-r(72)+r(73)-r(77) &
                       +r(80)+0.6*r(83)+r(85)-r(86)-r(93)+r(94)+0.52*r(99)+0.1*r(101)+r(103)-r(105)+0.3*r(105) &
                       +r(106)+r(106)+r(107)+0.06*r(109)+0.275*r(111)-r(114)+0.5*r(115)-r(120)+r(121)+0.1*r(126)
  yp(iCH3OOH)       = -r(8)+r(59)-r(60)
  yp(iHCHO)         = +r(8)-r(9)-r(10)+r(13)+r(17)+0.4*r(18)+0.25*r(19)+r(56)+r(57)+1.4*r(58)+0.4*r(60) &
                       -r(61)-r(62)+0.7*r(67)+0.5*r(73)+r(79)+0.53*r(83)+r(85)+r(94)+r(95)+r(99)+0.8*r(101) &
                       +r(103)+r(104)+0.3*r(105)+r(106)+r(106)+r(107)+0.8*r(109)+0.7*r(111)+r(121)+1.3*r(126)
  yp(iCO)           = +r(9)+r(10)+r(12)+r(17)+r(18)+0.25*r(19)+r(24)+r(61)+r(62)-r(63)+0.4*r(83)+0.42*r(99)+0.2 &
                       *r(101)+0.05*r(109)+0.2*r(111)+0.3*r(126)
  yp(iH2O2)         = -r(11)+r(34)-r(35)
  yp(iCH3CHO)       = -r(12)+r(13)+r(20)+r(65)+0.8*r(67)+1.6*r(68)+0.5*r(69)+0.5*r(83)+r(85)-r(88)-r(89)+0.04 &
                       *r(109)
  yp(iCH3O2)        = +r(12)+r(14)+r(23)+r(54)+r(55)-r(57)-r(58)-r(58)-r(59)+0.58*r(60)-r(67)-r(73)+0.3 &
                       *r(83)+r(90)-r(94)+r(94)-r(95)+r(96)+r(96)-r(106)-r(121)+r(122)
  yp(iC3H6OHOOH)    = -r(13)+r(86)-r(87)
  yp(iCH3COOOH)     = -r(14)+0.67*r(93)-r(97)
  yp(iPAN)          = -r(15)+r(91)-r(92)
  yp(iCH3CO3)       = +r(15)+0.4*r(18)+r(19)+r(23)+r(24)+r(79)+r(88)+r(89)-r(90)-r(91)+r(92)-r(93)-r(94) &
                       -r(95)-r(96)-r(96)+r(97)+0.59*r(104)-r(107)+r(112)+0.3*r(114)+0.5*r(115)+r(116)-r(122)
  yp(iMPAN)         = -r(16)+r(118)-r(119)
  yp(iMCO3)         = +r(16)+r(18)+0.5*r(110)-r(117)-r(118)+r(119)-r(120)-r(121)-r(122)-r(123)-r(123)
  yp(iCH2OHCHO)     = -r(17)+0.59*r(104)+r(112)+0.3*r(114)-r(115)-r(116)
  yp(iMACR)         = -r(18)+0.66*r(101)+0.58*r(103)+0.174*r(105)+r(106)+r(107)-r(110)-r(111)+1.1*r(126)
  yp(iCH3COCHO)     = +0.6*r(18)-r(24)+r(80)+0.82*r(109)+0.8*r(111)
  yp(iMVK)          = -r(19)+0.26*r(101)+0.42*r(103)+0.126*r(105)-r(108)-r(109)+0.4*r(126)
  yp(iC2H5OOH)      = -r(20)+r(66)-r(69)
  yp(iC3H7OOH)      = -r(21)+r(72)-r(74)
  yp(iCH3COCH3)     = +0.82*r(21)-r(23)+0.82*r(71)+0.82*r(73)-r(75)+r(125)
  yp(iCH3COCH2OOH)  = -r(22)+r(77)-r(78)
  yp(iCH3COCH2O)    = +r(22)+r(76)-r(79)-r(80)+r(117)+r(121)+r(122)+r(123)+r(123)
  yp(iCH4)          = -r(54)-r(55)-r(56)+0.1*r(83)
  yp(iC2H6)         = -r(64)
  yp(iC2H5O2)       = +r(64)-r(65)-r(66)-r(67)-r(68)-r(68)+0.5*r(69)
  yp(iC3H8)         = -r(70)
  yp(iC3H7O2)       = +r(70)-r(71)-r(72)-r(73)+r(74)
  yp(iCH3COCH2O2)   = +r(75)-r(76)-r(77)+r(78)
  yp(iC4H10)        = -r(81)
  yp(iISO1)         = +0.8*r(81)+r(100)-r(103)-r(104)-r(105)-r(106)-r(107)+1.64*r(125)+1.7*r(127)
  yp(iC3H6)         = -r(82)-r(83)-r(84)+0.1*r(101)+0.1*r(126)
  yp(iC3H6OHO2)     = +r(82)-r(85)-r(86)+0.5*r(87)+0.67*r(98)
  yp(iONIT)         = +r(84)+r(102)+0.41*r(104)+r(113)-r(124)
  yp(iCH3COOH)      = +0.33*r(93)+r(95)
  yp(iC2H4)         = -r(98)-r(99)
  yp(iC5H8)         = -r(100)-r(101)-r(102)
  yp(iMOHO2)        = +r(108)+0.5*r(110)-r(112)-r(113)-r(114)+r(120)+r(124)
  yp(iTERP)         = -r(125)-r(126)-r(127)
...
subroutine RxnRates(neqn,k,y,r)
  ...
  r(11)    = k(11)*y(iH2O2)
  r(12)    = k(12)*y(iCH3CHO)
  r(13)    = k(13)*y(iC3H6OHOOH)
  r(14)    = k(14)*y(iCH3COOOH)
  r(15)    = k(15)*y(iPAN)
  r(16)    = k(16)*y(iMPAN)
  r(17)    = k(17)*y(iCH2OHCHO)
  r(18)    = k(18)*y(iMACR)
  r(19)    = k(19)*y(iMVK)
  r(20)    = k(20)*y(iC2H5OOH)
  r(21)    = k(21)*y(iC3H7OOH)
  r(22)    = k(22)*y(iCH3COCH2OOH)
  r(23)    = k(23)*y(iCH3COCH3)
  r(24)    = k(24)*y(iCH3COCHO)
  r(25)    = k(25)*y(iO1D)
  r(26)    = k(26)*y(iO1D)
  r(27)    = k(27)*y(iO1D)
  r(28)    = k(28)*y(iO3P)
  r(29)    = k(29)*y(iO3P)*y(iO3)
  r(30)    = k(30)*y(iO3P)*y(iOH)
  r(31)    = k(31)*y(iO3P)*y(iHO2)
  r(32)    = k(32)*y(iOH)*y(iO3)
  r(33)    = k(33)*y(iHO2)*y(iO3)
  r(34)    = k(34)*y(iHO2)*y(iHO2)
  r(35)    = k(35)*y(iH2O2)*y(iOH)
  r(36)    = k(36)*y(iOH)*y(iHO2)
  r(37)    = k(37)*y(iOH)*y(iOH)
  r(38)    = k(38)*y(iOH)
  r(39)    = k(39)*y(iO1D)
  r(40)    = k(40)*y(iNO)*y(iHO2)
  r(41)    = k(41)*y(iNO)*y(iO3)
  r(42)    = k(42)*y(iNO2)*y(iO3P)
  r(43)    = k(43)*y(iNO2)*y(iO3)
  r(44)    = k(44)*y(iNO3)*y(iHO2)
  r(45)    = k(45)*y(iNO2)*y(iNO3)
  r(46)    = k(46)*y(iN2O5)
  r(47)    = k(47)*y(iN2O5)
  r(48)    = k(48)*y(iNO2)*y(iOH)
  r(49)    = k(49)*y(iHNO3)*y(iOH)
  r(50)    = k(50)*y(iNO3)*y(iNO)
  r(51)    = k(51)*y(iNO2)*y(iHO2)
  r(52)    = k(52)*y(iHO2NO2)
  r(53)    = k(53)*y(iHO2NO2)*y(iOH)
  r(54)    = k(54)*y(iCH4)*y(iOH)
  r(55)    = k(55)*y(iCH4)*y(iO1D)
  r(56)    = k(56)*y(iCH4)*y(iO1D)
  r(57)    = k(57)*y(iCH3O2)*y(iNO)
  r(58)    = k(58)*y(iCH3O2)*y(iCH3O2)
  r(59)    = k(59)*y(iCH3O2)*y(iHO2)
  r(60)    = k(60)*y(iCH3OOH)*y(iOH)
  r(61)    = k(61)*y(iHCHO)*y(iOH)
  r(62)    = k(62)*y(iHCHO)*y(iNO3)
  r(63)    = k(63)*y(iCO)*y(iOH)
  r(64)    = k(64)*y(iC2H6)*y(iOH)
  r(65)    = k(65)*y(iC2H5O2)*y(iNO)
  r(66)    = k(66)*y(iC2H5O2)*y(iHO2)
  r(67)    = k(67)*y(iC2H5O2)*y(iCH3O2)
  r(68)    = k(68)*y(iC2H5O2)*y(iC2H5O2)
  r(69)    = k(69)*y(iC2H5OOH)*y(iOH)
  r(70)    = k(70)*y(iC3H8)*y(iOH)
  r(71)    = k(71)*y(iC3H7O2)*y(iNO)
  r(72)    = k(72)*y(iC3H7O2)*y(iHO2)
  r(73)    = k(73)*y(iC3H7O2)*y(iCH3O2)
  r(74)    = k(74)*y(iC3H7OOH)*y(iOH)
  r(75)    = k(75)*y(iCH3COCH3)*y(iOH)
  r(76)    = k(76)*y(iCH3COCH2O2)*y(iNO)
  r(77)    = k(77)*y(iCH3COCH2O2)*y(iHO2)
  r(78)    = k(78)*y(iCH3COCH2OOH)*y(iOH)
  r(79)    = k(79)*y(iCH3COCH2O)
  r(80)    = k(80)*y(iCH3COCH2O)
  r(81)    = k(81)*y(iC4H10)*y(iOH)
  r(82)    = k(82)*y(iC3H6)*y(iOH)
  r(83)    = k(83)*y(iC3H6)*y(iO3)
  r(84)    = k(84)*y(iC3H6)*y(iNO3)
  r(85)    = k(85)*y(iC3H6OHO2)*y(iNO)
  r(86)    = k(86)*y(iC3H6OHO2)*y(iHO2)
  r(87)    = k(87)*y(iC3H6OHOOH)*y(iOH)
  r(88)    = k(88)*y(iCH3CHO)*y(iOH)
  r(89)    = k(89)*y(iCH3CHO)*y(iNO3)
  r(90)    = k(90)*y(iCH3CO3)*y(iNO)
  r(91)    = k(91)*y(iCH3CO3)*y(iNO2)
  r(92)    = k(92)*y(iPAN)
  r(93)    = k(93)*y(iCH3CO3)*y(iHO2)
  r(94)    = k(94)*y(iCH3CO3)*y(iCH3O2)
  r(95)    = k(95)*y(iCH3CO3)*y(iCH3O2)
  r(96)    = k(96)*y(iCH3CO3)*y(iCH3CO3)
  r(97)    = k(97)*y(iCH3COOOH)*y(iOH)
  r(98)    = k(98)*y(iC2H4)*y(iOH)
  r(99)    = k(99)*y(iC2H4)*y(iO3)
  r(100)   = k(100)*y(iC5H8)*y(iOH)
  r(101)   = k(101)*y(iC5H8)*y(iO3)
  r(102)   = k(102)*y(iC5H8)*y(iNO3)
  r(103)   = k(103)*y(iISO1)*y(iNO)
  r(104)   = k(104)*y(iISO1)*y(iNO)
  r(105)   = k(105)*y(iISO1)*y(iHO2)
  r(106)   = k(106)*y(iISO1)*y(iCH3O2)
  r(107)   = k(107)*y(iISO1)*y(iCH3CO3)
  r(108)   = k(108)*y(iMVK)*y(iOH)
  r(109)   = k(109)*y(iMVK)*y(iO3)
  r(110)   = k(110)*y(iMACR)*y(iOH)
  r(111)   = k(111)*y(iMACR)*y(iO3)
  r(112)   = k(112)*y(iMOHO2)*y(iNO)
  r(113)   = k(113)*y(iMOHO2)*y(iNO)
  r(114)   = k(114)*y(iMOHO2)*y(iHO2)
  r(115)   = k(115)*y(iCH2OHCHO)*y(iOH)
  r(116)   = k(116)*y(iCH2OHCHO)*y(iNO3)
  r(117)   = k(117)*y(iMCO3)*y(iNO)
  r(118)   = k(118)*y(iMCO3)*y(iNO2)
  r(119)   = k(119)*y(iMPAN)
  r(120)   = k(120)*y(iMCO3)*y(iHO2)
  r(121)   = k(121)*y(iMCO3)*y(iCH3O2)
  r(122)   = k(122)*y(iMCO3)*y(iCH3CO3)
  r(123)   = k(123)*y(iMCO3)*y(iMCO3)
  r(124)   = k(124)*y(iONIT)*y(iOH)
  r(125)   = k(125)*y(iTERP)*y(iOH)
  r(126)   = k(126)*y(iTERP)*y(iO3)
  r(127)   = k(127)*y(iTERP)*y(iNO3)
...
subroutine GasPhotoRateCoeffs(ts, k)
  ...
  k(15)    = kphoto(jpana)
  k(16)    = kphoto(jpana)
  k(17)    = kphoto(jhoch2cho)
  k(18)    = kphoto(jmacra)+kphoto(jmacrb)
  k(19)    = kphoto(jmvka)+kphoto(jmvkb)
  k(20)    = kphoto(jch3ooh)
  k(21)    = kphoto(jch3ooh)
  k(22)    = kphoto(jpaa)
  k(23)    = kphoto(jacet)
...
subroutine GasThermalRateCoeffs(ts, k)
  ...
  ! Generated by chmgen for mechanism mozart
  k(25)    = 1.80D-11*N2*EXP(110/TEMP)
  k(26)    = 3.20D-11*O2*EXP(70/TEMP)
  k(27)    = 2.20D-10*H2Oz
  k(28)    = 5.6D-34*N2*(TEMP/300)**(-2.6)*O2+6.0D-34*O2*(TEMP/300)**(-2.6)*O2
  k(29)    = 8.00D-12*EXP(-2060/TEMP)
  k(30)    = 2.20D-11*EXP(120/TEMP)
  k(31)    = 3.00D-11*EXP(200/TEMP)
  k(32)    = 1.60D-12*EXP(-940/TEMP)
  k(33)    = 1.1D-14*EXP(-500/TEMP)
  k(34)    = KTYP3(2.3D-13,600.0D0,1.7D-33,1000.0D0,TEMP,AIR)
  k(35)    = 2.90D-12*EXP(-160/TEMP)
  k(36)    = 4.80D-11*EXP(250/TEMP)
  k(37)    = 4.20D-12*EXP(-240/TEMP)
  k(38)    = 5.50D-12*EXP(-2000/TEMP)*H2
  k(39)    = 1.00D-10*H2
  k(40)    = 3.50D-12*EXP(250/TEMP)
  k(41)    = 2.00D-12*EXP(-1400/TEMP)
  k(42)    = 6.50D-12*EXP(120/TEMP)
  k(43)    = 1.20D-13*EXP(-2450/TEMP)
  k(44)    = 2.30D-12*EXP(170/TEMP)
  k(45)    = TERM(2.0D-30,-4.4D0,0.0D0,1.4D-12,-0.7D0,0.0D0,0.6D0,TEMP,AIR)
  k(46)    = TERM(1.0D-3,-3.5D0,-11000.0D0,9.7D+14,0.1D0,-11080.0D0,0.45D0,TEMP,AIR)
  k(47)    = 2.00D-21*H2Oz
  k(48)    = TERM(2.0D-30,-3.0D0,0.0D0,2.5D-11,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(49)    = KTYP2(2.4D-14,460.0D0,2.7D-17,2199.0D0,6.5D-34,1335.0D0,TEMP,AIR)
  k(50)    = 1.50D-11*EXP(170/TEMP)
  k(51)    = TERM(1.8D-31,-3.2D0,0.0D0,4.7D-12,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(52)    = TERM(4.1D-5,0.0D0,-10650.0D0,4.8D+15,0.0D0,-11170.0D0,0.6D0,TEMP,AIR)
  k(53)    = 1.30D-12*EXP(380/TEMP)
  k(54)    = 2.45D-12*EXP(-1775/TEMP)
  k(55)    = 1.40D-10
  k(56)    = 1.40D-11
  k(57)    = 3.00D-12*EXP(280/TEMP)
  k(58)    = 2.50D-13*EXP(190/TEMP)
  k(59)    = 3.80D-13*EXP(800/TEMP)
  k(60)    = 3.80D-12*EXP(200/TEMP)
  k(61)    = 1.10D-11
  k(62)    = 6.00D-13*EXP(-2058/TEMP)
  k(63)    = KTYP3(1.44D-13,0.0D0,3.43D-33,0.0D0,TEMP,AIR)
  k(64)    = 8.70D-12*EXP(-1070/TEMP)
  k(65)    = 2.60D-12*EXP(365/TEMP)
  k(66)    = 7.50D-13*EXP(700/TEMP)
  k(67)    = 3.75D-13*EXP(-40/TEMP)
  k(68)    = 6.50D-14
  k(69)    = 3.80D-12*EXP(200/TEMP)
  k(70)    = 1.00D-11*EXP(-660/TEMP)
  k(71)    = 4.20D-12*EXP(180/TEMP)
  k(72)    = 7.50D-13*EXP(700/TEMP)
  k(73)    = 3.75D-13*EXP(-40/TEMP)
  k(74)    = 3.80D-12*EXP(200/TEMP)
  k(75)    = 2.20D-12*EXP(-685/TEMP)
  k(76)    = 4.20D-12*EXP(180/TEMP)
  k(77)    = 7.50D-13*EXP(700/TEMP)
  k(78)    = 3.80D-12*EXP(200/TEMP)
  k(79)    = 8.70D+13*AIR*EXP(-7300/TEMP)
  k(80)    = 6.50D-14*O2*EXP(-1400/TEMP)
  k(81)    = 1.55D-11*EXP(-540/TEMP)
  k(82)    = TERM(8.00D-27,-3.5D0,0.0D0,3.00D-11,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(83)    = 6.50D-15*EXP(-1900/TEMP)
  k(84)    = 4.00D-15
  k(85)    = 4.20D-12*EXP(180/TEMP)
  k(86)    = 6.50D-13*EXP(650/TEMP)
  k(87)    = 3.80D-12*EXP(200/TEMP)
  k(88)    = 5.60D-12*EXP(270/TEMP)
  k(89)    = 1.40D-12*EXP(-1900/TEMP)
  k(90)    = 5.30D-12*EXP(360/TEMP)
  k(91)    = TERM(9.70D-29,-5.6D0,0.0D0,9.30D-12,-1.5D0,0.0D0,0.6D0,TEMP,AIR)
  k(92)    = 1.11D+28*EXP(-14000/TEMP)*TERM(9.7D-29,-5.6D0,0.0D0,9.3D-12,-1.5D0,0.0D0,0.6D0,TEMP,AIR)
  k(93)    = 4.30D-13*EXP(1040/TEMP)
  k(94)    = 1.80D-09*EXP(-1800/TEMP)
  k(95)    = 4.10D-15*EXP(2100/TEMP)
  k(96)    = 2.90D-12*EXP(500/TEMP)
  k(97)    = 1.0D-11
  k(98)    = TERM(1.00D-28,-0.8D0,0.0D0,8.8D-12,0.0D0,0.0D0,0.6D0,TEMP,AIR)
  k(99)    = 1.20D-14*EXP(-2630/TEMP)
  k(100)   = 2.50D-11*EXP(450/TEMP)
  k(101)   = 1.20D-14*EXP(-2013/TEMP)
  k(102)   = 3.03D-12*EXP(-446/TEMP)
  k(103)   = 3.70D-12*EXP(180/TEMP)
  k(104)   = 5.00D-13*EXP(180/TEMP)
  k(105)   = 7.50D-13*EXP(750/TEMP)
  k(106)   = 1.30D-14
  k(107)   = 4.90D-14
  k(108)   = 4.13D-12*EXP(452/TEMP)
  k(109)   = 4.00D-15*EXP(-2000/TEMP)
  k(110)   = 1.86D-11*EXP(175/TEMP)
  k(111)   = 4.40D-15*EXP(-2500/TEMP)
  k(112)   = 3.50D-12*EXP(180/TEMP)
  k(113)   = 4.50D-13*EXP(180/TEMP)
  k(114)   = 7.50D-13*EXP(700/TEMP)
  k(115)   = 6.00D-12*EXP(250/TEMP)
  k(116)   = 1.40D-12*EXP(-1900/TEMP)
  k(117)   = 2.40D-11
  k(118)   = TERM(9.70D-29,-5.6D0,0.0D0,9.30D-12,-1.5D0,0.0D0,0.6D0,TEMP,AIR)
  k(119)   = 1.11D+28*EXP(-14000/TEMP)*TERM(9.7D-29,-5.6D0,0.0D0,9.3D-12,-1.5D0,0.0D0,0.6D0,TEMP,AIR)
  k(120)   = 4.50D-13*EXP(1040/TEMP)
  k(121)   = 2.20D-12*EXP(490/TEMP)
  k(122)   = 5.00D-12*EXP(550/TEMP)
  k(123)   = 2.50D-12*EXP(550/TEMP)
  k(124)   = 6.80D-13
  k(125)   = 1.20D-11*EXP(444/TEMP)
  k(126)   = 9.90D-16*EXP(-730/TEMP)
  k(127)   = 5.60D-11*EXP(-650/TEMP)

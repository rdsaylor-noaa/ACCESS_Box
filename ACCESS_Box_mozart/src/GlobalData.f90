...
module GlobalData
  ...
  character(len=11),parameter :: gasmech='mozart'

  ! Generated by chmgen for mechanism mozart
  ! ninteg - number of integrated species
  integer(kind=i4), parameter :: ninteg=48
  ...
  integer(kind=i4), parameter :: nrxn=127

  ! Species indices
  integer(kind=i4), parameter :: iNO          = 1
  integer(kind=i4), parameter :: iNO2         = 2
  integer(kind=i4), parameter :: iO3          = 3
  integer(kind=i4), parameter :: iO1D         = 4
  integer(kind=i4), parameter :: iO3P         = 5
  integer(kind=i4), parameter :: iN2O5        = 6
  integer(kind=i4), parameter :: iNO3         = 7
  integer(kind=i4), parameter :: iHNO3        = 8
  integer(kind=i4), parameter :: iHO2NO2      = 9
  integer(kind=i4), parameter :: iOH          = 10
  integer(kind=i4), parameter :: iHO2         = 11
  integer(kind=i4), parameter :: iCH3OOH      = 12
  integer(kind=i4), parameter :: iHCHO        = 13
  integer(kind=i4), parameter :: iCO          = 14
  integer(kind=i4), parameter :: iH2O2        = 15
  integer(kind=i4), parameter :: iCH3CHO      = 16
  integer(kind=i4), parameter :: iCH3O2       = 17
  integer(kind=i4), parameter :: iC3H6OHOOH   = 18
  integer(kind=i4), parameter :: iCH3COOOH    = 19
  integer(kind=i4), parameter :: iPAN         = 20
  integer(kind=i4), parameter :: iCH3CO3      = 21
  integer(kind=i4), parameter :: iMPAN        = 22
  integer(kind=i4), parameter :: iMCO3        = 23
  integer(kind=i4), parameter :: iCH2OHCHO    = 24
  integer(kind=i4), parameter :: iMACR        = 25
  integer(kind=i4), parameter :: iCH3COCHO    = 26
  integer(kind=i4), parameter :: iMVK         = 27
  integer(kind=i4), parameter :: iC2H5OOH     = 28
  integer(kind=i4), parameter :: iC3H7OOH     = 29
  integer(kind=i4), parameter :: iCH3COCH3    = 30
  integer(kind=i4), parameter :: iCH3COCH2OOH = 31
  integer(kind=i4), parameter :: iCH3COCH2O   = 32
  integer(kind=i4), parameter :: iCH4         = 33
  integer(kind=i4), parameter :: iC2H6        = 34
  integer(kind=i4), parameter :: iC2H5O2      = 35
  integer(kind=i4), parameter :: iC3H8        = 36
  integer(kind=i4), parameter :: iC3H7O2      = 37
  integer(kind=i4), parameter :: iCH3COCH2O2  = 38
  integer(kind=i4), parameter :: iC4H10       = 39
  integer(kind=i4), parameter :: iISO1        = 40
  integer(kind=i4), parameter :: iC3H6        = 41
  integer(kind=i4), parameter :: iC3H6OHO2    = 42
  integer(kind=i4), parameter :: iONIT        = 43
  integer(kind=i4), parameter :: iCH3COOH     = 44
  integer(kind=i4), parameter :: iC2H4        = 45
  integer(kind=i4), parameter :: iC5H8        = 46
  integer(kind=i4), parameter :: iMOHO2       = 47
  integer(kind=i4), parameter :: iTERP        = 48

  ! Species strings
  character(len=11), parameter, dimension(ntotal) ::  &
                     sspc     = (/         &
                                   'NO         ', &
                                   'NO2        ', &
                                   'O3         ', &
  ...
  integer(kind=i4), parameter :: noutppb=15
  integer(kind=i4), dimension(noutppb) :: outppb
  data outppb / iNO, iNO2, iO3, iHNO3, iHO2NO2, iN2O5, iCH4, iHCHO, &
                iCO, iH2O2, iC5H8, iMVK, iMACR, iPAN, iTERP /
